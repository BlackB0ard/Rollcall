...
path='./09_10_19/DBMS/DBMS_09_10_19.xlsx'
column='I'
...
currentDir = os.path.dirname(os.path.abspath('')+"/"+"FaceRecognition-Attendance-Marking-master")
...
#imgurl = urllib.request.pathname2url(os.path.join(currentDir, "1.jpg"))
#print(imgurl)
#res = CF.face.detect(imgurl)
#faceIds = []
#for face in res:
